...
//
// NotificationsProvider (Smart Notifications, review χρήστη) — τυλίγει Header + main + BottomNav
// ώστε ΚΑΘΕ σελίδα (κάθε μία φτιάχνει το δικό της AppShell, βλ. σχόλιο πιο πάνω) να έχει αυτόματα
// ΕΝΑ κοινό, ήδη-υπολογισμένο notification dataset — καμία σελίδα δεν χρειάζεται να ξέρει τίποτα
// γι' αυτό ρητά.
